...
| [Telegram AI Bot](https://github.com/theman6660/telegram-ai-bot) | Telegram bot with LLM interaction, deployment notes, snippets and automation hooks | Node.js, Gemini API, Telegram Bot API, Railway |
| [Personal Website Automation](https://github.com/theman6660/beifen) | Hexo site source with AI daily generation, chronicle updates, deployment and rollback workflow | Hexo, GitHub Actions, DeepSeek API, RSS |
| [Escher Droste Tool](https://github.com/theman6660/escher-droste-tool) | Browser-based WebGL tool for Droste / Escher-style image transformation | WebGL, Canvas, image processing |

More details: [PROJECTS.md](./PROJECTS.md)
...
- [telegram-ai-bot](https://github.com/theman6660/telegram-ai-bot) - Telegram AI chatbot and deployment workflow
- [beifen](https://github.com/theman6660/beifen) - source repository for [hanxiaofan.site](https://hanxiaofan.site)
- [theman6660.github.io](https://github.com/theman6660/theman6660.github.io) - generated GitHub Pages site
- [escher-droste-tool](https://github.com/theman6660/escher-droste-tool) - single-page WebGL visual tool
- [program](https://github.com/theman6660/program) - Python GUI experiment for process-card generation
- [vidio](https://github.com/theman6660/vidio) - computer vision desktop experiment with FaceNet / MTCNN

## Contact

- Email: hanxianfan123@qq.com
- Website: [hanxiaofan.site](https://hanxiaofan.site)
- GitHub: [@theman6660](https://github.com/theman6660)
